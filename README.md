...
This release is being worked on to provide support for the awesome UH-60L mod (it might work with its sub-mods at the moment, but just the UH-60L and its armed version have been tested so far).
